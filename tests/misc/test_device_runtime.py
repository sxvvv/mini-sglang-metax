...
These tests never require a real CUDA install. They inject a fake ``torch``
module into ``sys.modules`` so the dispatch layer can be exercised on a bare
CPU-only host.
...
# ---------------------------------------------------------------------------
# stream_context — cuda / cpu dispatch
# ---------------------------------------------------------------------------
