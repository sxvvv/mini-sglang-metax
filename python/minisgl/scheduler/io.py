...
class SchedulerIOMixin:
    ...
    def __init__(self, config: SchedulerConfig, tp_cpu_group: torch.distributed.ProcessGroup):
        ...
        # The offline driver never creates transport queues. Keep their
        # msgpack/pyzmq dependencies out of that import and initialization
        # path so hardware bring-up can run in a minimal inference image.
